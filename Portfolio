...
<html lang="en">
 <head>
  ...
  <title>Nagarjuna dasari - Cyber Athlete Portfolio</title>
 ...
 <body>
  ...
  <main><!-- Hero Section -->
   <section class="hero-section">
    <div class="athlete-card neon-glow">
     ...
     <h1 class="athlete-name" id="athlete-name">NAGARJUNA DASARI</h1>
   ...
   <section class="achievements-section">
    ...
    <div style="max-width: 800px; margin: 0 auto 4rem auto;">
     ...
     <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 1.5rem;">
      <div class="stat-item" style="cursor: pointer;" onclick="window.open('mailto:nagarjuna.dasari@email.com', '_blank')">
  ...
  <script>
        ...
        const defaultConfig = {
            ...
            cert4_issuer: "Udemy",
            cert4_date: "2023",
            email: "nagarjuna dasari@email.com",
            phone: "+91 98765 43210",
            location: "Hyderabad, India",
            linkedin_handle: "@nagarjuna",
            github_handle: "@nagarjuna",
            twitter_handle: "@venkatesh_sec",
            discord_handle: "nagarjuna#2024",
            medium_handle: "@nagarjunadasari",
            youtube_handle: "NagarjunaCyber"
        };
